...
const userSchema = new mongoose.Schema({
    ...
    status: { type: String, default: "Available" }, // 🔥 Status/Bio added
...
// 🔥 UPDATE SETTINGS (PROFILE + PRIVACY)
